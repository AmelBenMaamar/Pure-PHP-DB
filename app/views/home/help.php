...
.card h2[style*="primary"] { color: #6B74D6 !important; }
...
details summary::before { content: '+ '; color: #6B74D6; font-weight: 700; }
details[open] summary::before { content: '− '; }
details summary:hover { color: #6B74D6; }
details p { font-family: 'Manrope', sans-serif; font-size: .93rem; line-height: 1.75; color: #4b5563 !important; }
details p a { color: #6B74D6 !important; font-weight: 500; text-decoration: none; border-bottom: 1px solid #c4baff; }
...
.btn.btn-primary.btn-lg { background: #6B74D6; border-color: #6B74D6; color: #fff; font-family: 'Manrope', sans-serif; font-weight: 600; border-radius: 8px; transition: background .2s, transform .15s; }
