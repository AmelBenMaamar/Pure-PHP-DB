 ...
 * 
 * Ce fichier détecte automatiquement l'environnement (local vs production)
 * et adapte les chemins CSS/JS en conséquence
 */
...
// ================================================================
// Railway définit RAILWAY_ENVIRONMENT en production
...
// Donc /public/ EST la racine web, les fichiers sont à /css/ pas /public/css/
    ...
    // ============================================================
    // En local, le serveur PHP intégré démarre depuis /public/
    // Donc les fichiers sont accessibles directement à /css/, /js/
    define('CSS_URL', APP_URL . '/css');
    define('JS_URL', APP_URL . '/js');
    define('IMG_URL', APP_URL . '/img');
    define('UPLOAD_URL', APP_URL . '/uploads');
...
if (file_exists(__DIR__ . '/../.env')) {
    ...
    foreach ($lines as $line) {
        ...
        // Définir la variable d'environnement si nom et valeur non vides
